...
function onGoSettlement(row: SalesOrderListItem): void {
    ...
    >
      ...
      >
        ...
        <template #settlement="{ record }">
          <a-tag :color="settlementStateColor((record as SalesOrderListItem).settlementState)">
            {{ settlementStateLabel((record as SalesOrderListItem).settlementState, (record as SalesOrderListItem).unsettledAmount) }}
          </a-tag>
        </template>
        ...
        <template #action="{ record }">
          ...
          >
            ...
            <a-button
              ...
              type="text"
              size="small"
              @click="onGoSettlement(record as SalesOrderListItem)"
            >
              <template #icon>
                <IconCash />
              </template>

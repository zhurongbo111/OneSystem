...
public sealed record SalesOrderDetail
{
    ...
    public required IReadOnlyList<SalesOrderDetailItem> Items { get; init; }
}

/// <summary>销售单明细读模型（快照字段原样返回）</summary>
public sealed record SalesOrderDetailItem
{

...
/// <summary>
/// 盘点单分页查询请求格式校验：只做数据格式检查（长度引用 StockTakeFieldConstraints）。
/// </summary>
public sealed class GetStockTakesRequestValidator : AbstractValidator<GetStockTakesRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public GetStockTakesRequestValidator()
    {

...
/// <summary>
/// 采购入库单导出请求格式校验：与列表查询规则完全一致（只做数据格式检查）
/// </summary>
public sealed class ExportPurchaseReceiptsRequestValidator : AbstractValidator<ExportPurchaseReceiptsRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public ExportPurchaseReceiptsRequestValidator()
    {
        ...
        // 长度统一取自 OrderFieldConstraints（禁止硬编码；与 ReceiptNo 列长一致）

...
/// <summary>
/// 销售退货单分页查询请求格式校验：只做数据格式检查
/// </summary>
public sealed class GetSalesReturnsRequestValidator : AbstractValidator<GetSalesReturnsRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public GetSalesReturnsRequestValidator()
    {

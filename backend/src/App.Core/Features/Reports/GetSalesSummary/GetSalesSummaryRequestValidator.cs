...
/// <summary>
/// 销售汇总查询请求格式校验：只做数据格式检查，不访问仓储（design.md §3.5）。
/// </summary>
public sealed class GetSalesSummaryRequestValidator : AbstractValidator<GetSalesSummaryRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public GetSalesSummaryRequestValidator()
    {
        RuleFor(x => x.Start)

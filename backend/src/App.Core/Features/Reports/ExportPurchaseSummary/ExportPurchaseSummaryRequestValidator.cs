...
/// <summary>
/// 采购汇总导出请求格式校验：与报表查询规则完全一致（只做数据格式检查）
/// </summary>
public sealed class ExportPurchaseSummaryRequestValidator : AbstractValidator<ExportPurchaseSummaryRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public ExportPurchaseSummaryRequestValidator()
    {
        RuleFor(x => x.Start)

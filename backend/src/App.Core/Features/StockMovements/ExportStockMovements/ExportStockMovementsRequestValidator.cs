...
/// <summary>
/// 库存流水导出请求格式校验：与列表查询规则完全一致（只做数据格式检查，不访问仓储）
/// </summary>
public sealed class ExportStockMovementsRequestValidator : AbstractValidator<ExportStockMovementsRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public ExportStockMovementsRequestValidator()
    {
        RuleFor(x => x.Page)

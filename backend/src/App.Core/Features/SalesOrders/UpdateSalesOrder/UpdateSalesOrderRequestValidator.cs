...
/// <summary>
/// 编辑销售订单请求格式校验：只做数据格式检查。
/// 存在性 / 状态流转（仅「待发货」可改）等查库约束在 Handler 中判断（后端规则 §4.1）。
/// </summary>

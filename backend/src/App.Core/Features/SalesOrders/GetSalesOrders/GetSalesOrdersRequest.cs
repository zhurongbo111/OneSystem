...
/// <summary>
/// 销售订单分页查询请求（Query 参数绑定；只读）
/// </summary>
public sealed class GetSalesOrdersRequest : IRequest<PagedResult<SalesOrderListItemDto>>
{
    ...
    /// <summary>订单号 / 客户名称关键词，可空</summary>
    public string? Keyword { get; init; }

    /// <summary>客户 id，可空</summary>
    public Guid? PartnerId { get; init; }

    /// <summary>订单流转状态，可空（0 已作废 / 1 待发货 / 2 部分发货 / 3 已完成 / 4 已关闭）</summary>

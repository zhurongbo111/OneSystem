...
/// <summary>
/// 采购退货单导出请求格式校验：与列表查询规则完全一致（只做数据格式检查）
/// </summary>
public sealed class ExportPurchaseReturnsRequestValidator : AbstractValidator<ExportPurchaseReturnsRequest>
{
    /// <summary>
    /// 初始化校验规则
    /// </summary>
    public ExportPurchaseReturnsRequestValidator()
    {

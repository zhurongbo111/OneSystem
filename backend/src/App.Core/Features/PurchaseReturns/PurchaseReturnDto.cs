...
/// <summary>
/// 采购退货单出参共享模型（主表 + 明细，与后端 DTO camelCase 一一对应；列表行用 PurchaseReturnListItemDto）
/// </summary>
public sealed class PurchaseReturnDetailDto
{
    ...
    public required IReadOnlyList<PurchaseReturnItemDto> Items { get; init; }
}

/// <summary>采购退货单明细出参模型（快照字段原样返回）</summary>
public sealed class PurchaseReturnItemDto
{
...
/// <summary>采购退货单列表行出参模型（含 Status 供前端作废行置灰）</summary>

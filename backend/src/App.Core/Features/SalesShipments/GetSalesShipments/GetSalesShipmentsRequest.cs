...
/// <summary>
/// 销售单分页查询请求（Query 参数绑定；只读）
/// </summary>
public sealed class GetSalesShipmentsRequest : IRequest<PagedResult<SalesShipmentListItemDto>>
{
    ...
    /// <summary>关联销售订单 id，可空（按订单筛选出库单）</summary>
